...
namespace QmsDocXml
{
    public class CompanyDocumentProperty : DocProperty
    {
        public CompanyDocumentProperty()
        {
        }

        public CompanyDocumentProperty(object state) : base(state)
        {
        }

        public CompanyDocumentProperty(object state, int stateCount) : base(state, stateCount)
        {
        }
